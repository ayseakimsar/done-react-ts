      ...
      <div className="mt-5">
        {labels
          ...
          .map((label) => (
            <div
              key={label.id}
              className={`m-[0.4rem] flex h-[auto] items-center justify-between rounded-lg p-1 px-3 text-[14px] font-medium tracking-[0.07em] text-light-primaryText dark:text-dark-primaryText`}
